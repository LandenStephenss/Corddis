...
class Shard extends EventEmitter {
  ...
  identify(options) {
    ...
    this.sendWS(constants.opcodes.IDENTIFY, {
  ...
  resume() {
    this.sendWS(constants.opcodes.RESUME, {
      seq: this.seq,
  ...
  _onWSClose(code, reason) { // eslint-disable-line no-unused-vars
    switch (code) {
      ...
      case constants.gatewayCloseCodes.UNKNOWN_ERROR: {
        break;
      }

      case constants.gatewayCloseCodes.UNKNOWN_OPCODE: {
        break;
      }

      case constants.gatewayCloseCodes.DECODE_ERROR: {
        break;
      }

      case constants.gatewayCloseCodes.NOT_AUTHENTICATED: {
        break;
      }

      case constants.gatewayCloseCodes.AUTHENTICATION_FAILED: {
        break;
      }

      case constants.gatewayCloseCodes.ALREADY_AUTHENTICATED: {
        break;
      }

      case constants.gatewayCloseCodes.INVALID_SEQ: {
        break;
      }

      case constants.gatewayCloseCodes.RATE_LIMITED: {
        break;
      }

      case constants.gatewayCloseCodes.SESSION_TIMEOUT: {
        break;
      }

      case constants.gatewayCloseCodes.INVALID_SHARD: {
        break;
      }

      case constants.gatewayCloseCodes.SHARDING_REQUIRED: {
        break;
      }

      case constants.gatewayCloseCodes.INVALID_VERSION: {
        break;
      }

      case constants.gatewayCloseCodes.INVALID_INTENTS: {
        break;
      }

      case constants.gatewayCloseCodes.DISALLOWED_INTENTS: {
        break;
      }
    }
  }
  ...
  heartbeat() {
    ...
    this.sendWS(constants.opcodes.HEARTBEAT, this.seq);
  }
  ...
  updateStatus(options) {
    ...
    this.sendWS(constants.opcodes.STATUS_UPDATE, {
      afk: !!options.afk,
      game,
  ...
  requestGuildMembers(guildID, options = {}) {
    this.sendWS(constants.opcodes.REQUEST_GUILD_MEMBERS, {
      guild_id: guildID,
      query: options.query || '',
