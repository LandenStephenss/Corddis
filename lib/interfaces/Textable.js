module.exports = {
  ...
  createMessageReaction(messageID, emoji) {
    const data = [this.id, messageID, emoji];
    return this.client.rest.createChannelMessageReaction(...data);
  },
  ...
  getMessageReactionUsers(messageID, emoji, options) {
    const data = [this.id, messageID, emoji, options];
    return this.client.rest.getChannelMessageReactionUsers(...data);
  },
  ...
  removeMessageReaction(messageID, emoji, userID) {
    ...
    return this.client.rest.removeChannelMessageReaction(...data);
  },
