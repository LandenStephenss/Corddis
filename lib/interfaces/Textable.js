module.exports = {
  ...
  clearMessageReactions(messageID) {
    return this.client.rest.clearMessageReactions(this.id, messageID);
  },
  ...
  getMessages(channelID, options) {
    return this.client.rest.getMessages(this.id, channelID, options);
  },
  ...
  deleteMessages(messageIDs) {
    return this.client.rest.deleteMessages(this.id, messageIDs);
  },
