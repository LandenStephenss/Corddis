...
class Guild extends Base {
   ...
   * @param {RequestGuildMembersOptions} [options] Request guild membesr options
   * @returns {Promise<void>}
   */
  requestMembers(limit, options) {
    return this.shard.requestGuildMembers(this.id, limit, options);
  }
