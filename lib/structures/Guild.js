...
class Guild extends Base {
   ...
   */
  kickMember(memberID) {
    return this.client.rest.kickGuildMember(this.id, memberID);
  }
   ...
   */
  banMember(memberID) {
    return this.client.rest.banGuildMember(this.id, memberID);
  }
   ...
   */
  unban(userID) {
    return this.client.rest.unbanUserFromGuild(this.id, userID);
  }
}
